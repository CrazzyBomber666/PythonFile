"""
Django settings for TelegramParsing project.
...
SECRET_KEY = 'ekw&*j)!3bz3m7v0$%4%!kg&&h9dm(oh)gdntku=*#%!j=gs9m'
...
ROOT_URLCONF = 'TelegramParsing.urls'
...
WSGI_APPLICATION = 'TelegramParsing.wsgi.application'
